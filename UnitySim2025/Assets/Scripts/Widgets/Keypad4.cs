...
// need to create logic for working with decimal numbers
public class Keypad4 : MonoBehaviour, IKeypad
{
    Image button1;
    Image button2;
    Image button3;
    ...
    void Start()
    {
        button0 = GameObject.Find("Canvas/Widgets/Keypad4/0 Button").GetComponent<Image>();
        button1 = GameObject.Find("Canvas/Widgets/Keypad4/1 Button").GetComponent<Image>();
        button2 = GameObject.Find("Canvas/Widgets/Keypad4/2 Button").GetComponent<Image>();
        button3 = GameObject.Find("Canvas/Widgets/Keypad4/3 Button").GetComponent<Image>();
        button4 = GameObject.Find("Canvas/Widgets/Keypad4/4 Button").GetComponent<Image>();
        button5 = GameObject.Find("Canvas/Widgets/Keypad4/5 Button").GetComponent<Image>();
        button6 = GameObject.Find("Canvas/Widgets/Keypad4/6 Button").GetComponent<Image>();
        button7 = GameObject.Find("Canvas/Widgets/Keypad4/7 Button").GetComponent<Image>();
        button8 = GameObject.Find("Canvas/Widgets/Keypad4/8 Button").GetComponent<Image>();
        button9 = GameObject.Find("Canvas/Widgets/Keypad4/9 Button").GetComponent<Image>();
        buttonPlusMinus = GameObject.Find("Canvas/Widgets/Keypad4/PlusMinus Button").GetComponent<Image>();
        buttonConfirm = GameObject.Find("Canvas/Widgets/Keypad4/Confirm Button").GetComponent<Image>();
        buttonDelete = GameObject.Find("Canvas/Widgets/Keypad4/Delete Button").GetComponent<Image>();
        buttonDecimal =GameObject.Find("Canvas/Widgets/Keypad4/Decimal Button").GetComponent<Image>();

        value = GameObject.Find("Canvas/Widgets/Keypad4/Keypad Display/Display Value").GetComponent<Text>();

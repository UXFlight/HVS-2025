...
public class Keypad3 : MonoBehaviour, IKeypad
{
    Image button1;
    Image button2;
    Image button3;
    ...
    void Start()
    {
        button0 = GameObject.Find("Canvas/Widgets/Keypad3/0 Button").GetComponent<Image>();
        button1 = GameObject.Find("Canvas/Widgets/Keypad3/1 Button").GetComponent<Image>();
        button2 = GameObject.Find("Canvas/Widgets/Keypad3/2 Button").GetComponent<Image>();
        button3 = GameObject.Find("Canvas/Widgets/Keypad3/3 Button").GetComponent<Image>();
        button4 = GameObject.Find("Canvas/Widgets/Keypad3/4 Button").GetComponent<Image>();
        button5 = GameObject.Find("Canvas/Widgets/Keypad3/5 Button").GetComponent<Image>();
        button6 = GameObject.Find("Canvas/Widgets/Keypad3/6 Button").GetComponent<Image>();
        button7 = GameObject.Find("Canvas/Widgets/Keypad3/7 Button").GetComponent<Image>();
        button8 = GameObject.Find("Canvas/Widgets/Keypad3/8 Button").GetComponent<Image>();
        button9 = GameObject.Find("Canvas/Widgets/Keypad3/9 Button").GetComponent<Image>();
        buttonPlusMinus = GameObject.Find("Canvas/Widgets/Keypad3/PlusMinus Button").GetComponent<Image>();
        buttonConfirm = GameObject.Find("Canvas/Widgets/Keypad3/Confirm Button").GetComponent<Image>();
        buttonDelete = GameObject.Find("Canvas/Widgets/Keypad3/Delete Button").GetComponent<Image>();

        value = GameObject.Find("Canvas/Widgets/Keypad3/Keypad Display/Display Value").GetComponent<Text>();

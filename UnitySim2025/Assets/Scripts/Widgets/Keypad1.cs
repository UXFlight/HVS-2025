...
public class Keypad1 : MonoBehaviour, IKeypad
{
    Image button1;
    Image button2;
    Image button3;
    ...
    void Start()
    {
        button0 = GameObject.Find("Canvas/Widgets/Keypad1/0 Button").GetComponent<Image>();
        button1 = GameObject.Find("Canvas/Widgets/Keypad1/1 Button").GetComponent<Image>();
        button2 = GameObject.Find("Canvas/Widgets/Keypad1/2 Button").GetComponent<Image>();
        button3 = GameObject.Find("Canvas/Widgets/Keypad1/3 Button").GetComponent<Image>();
        button4 = GameObject.Find("Canvas/Widgets/Keypad1/4 Button").GetComponent<Image>();
        button5 = GameObject.Find("Canvas/Widgets/Keypad1/5 Button").GetComponent<Image>();
        button6 = GameObject.Find("Canvas/Widgets/Keypad1/6 Button").GetComponent<Image>();
        button7 = GameObject.Find("Canvas/Widgets/Keypad1/7 Button").GetComponent<Image>();
        button8 = GameObject.Find("Canvas/Widgets/Keypad1/8 Button").GetComponent<Image>();
        button9 = GameObject.Find("Canvas/Widgets/Keypad1/9 Button").GetComponent<Image>();
        buttonPlusMinus = GameObject.Find("Canvas/Widgets/Keypad1/PlusMinus Button").GetComponent<Image>();
        buttonConfirm = GameObject.Find("Canvas/Widgets/Keypad1/Confirm Button").GetComponent<Image>();
        buttonDelete = GameObject.Find("Canvas/Widgets/Keypad1/Delete Button").GetComponent<Image>();
